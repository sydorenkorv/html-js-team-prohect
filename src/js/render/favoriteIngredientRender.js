...
import { toggleToFavoriteCocktail } from './favoriteCocktail';

const ingredientCardList = document.querySelector('.favorite__list-ingredient');

export function changeElementVisibility(elem, key) {
...
console.log(ingredientCardList);
// ingredientCardList.addEventListener('click', toggleToFavoriteCocktail);
